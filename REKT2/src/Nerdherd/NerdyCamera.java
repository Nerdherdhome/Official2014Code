...
public class NerdyCamera extends Thread{
    ...
    private Pointer imagePointer = null;
    ...
    public void run() {
        while(cameraActive){
            ...
            try{
                ...
                //thresholdImage = image.thresholdHSV(18, 27, 40, 255, 90, 255); //not so good orange filter
                thresholdImage = image.thresholdRGB(150, 255, 150, 255, 50, 150); //good orange filter
            ...
            SmartDashboard.putDouble("TimePassedCamera", timePassed);
            SmartDashboard.putDouble("SleepTimeCamera", sleepTime);
            System.out.println("hello i am camera");
            if(sleepTime < 0){
                sleepTime = 0.001;
            }
            try{
