...
public class NerdyPIDController{
    ...
    private double headingTolerance = 3, distanceTolerance = 2.5;
    ...
    public Compressor roboComp;
    boolean isInHighGear = false; 
    boolean lastVal = false;
    int loopWait = 0;
    public boolean shiftUp=false, shiftDown=false;
