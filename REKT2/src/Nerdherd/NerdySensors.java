...
public class NerdySensors extends Thread{
    ...
    public NerdySensors(){
        ...
        distanceIntegrator =  new TrapezoidalIntegrator(NerdyBotThreaded.k_PeriodTime,100);
        speedIntegrator =  new TrapezoidalIntegrator(NerdyBotThreaded.k_PeriodTime,2048);
        calibrate();
