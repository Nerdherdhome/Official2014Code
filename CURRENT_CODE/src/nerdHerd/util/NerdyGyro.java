 ...
 */
public class NerdyGyro extends SensorBase implements PIDSource, ISensor, LiveWindowSendable {

    static final int kOversampleBits = 10;
    static final int kAverageBits = 0;
    static final double kSamplesPerSecond = 50.0;
    static final double kCalibrationSampleTime = 5.0;
    static final double kDefaultVoltsPerDegreePerSecond = 0.007;//0.0135
     ...
     */
    public NerdyGyro(int slot, int channel) {
     ...
     */
    public NerdyGyro(AnalogChannel channel) {
        m_analog = channel;
        if (m_analog == null) {
