...
public class ADXL345_I2C extends SensorBase {
    ...
    public ADXL345_I2C(int moduleNumber, DataFormat_Range range) {
        ...
        m_i2c.write(0x2C, 0x08);//Communicates to bw register to set the rate to 40ms
        

        UsageReporting.report(UsageReporting.kResourceType_ADXL345, UsageReporting.kADXL345_I2C, moduleNumber-1);
    }
